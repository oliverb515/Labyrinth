...
namespace Final
{
    ...
    abstract class MenuScreen : GameScreen
    {
        ...
        {
            menuEntries[entryIndex].OnSelectEntry(PlayerIndex.One);
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            for (int i = 0; i < menuEntries.Count; i++)
            {
                ...
                menuEntries[i].Update(this, false, gameTime);
            }
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            ScreenManager.GraphicsDevice.Clear(Color.Lavender);
